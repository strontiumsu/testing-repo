...
class Spectroscopy_689_exp(Scan1D, TimeFreqScan, EnvExperiment):
    ...
    def before_scan(self):
        ...
        self.Sq.init_aoms(on=False)  # initializes whiling keeping them off
    ...
    def measure(self, time, frequency):
        ...
        if self.scan == 'frequency':            
            self.Sq.set_AOM_freqs([('CavityProbe', frequency)])
            
        self.Sq.cavity_probe_pulse(10*ms)
        # perform experiment
        ...
        self.Sq.cavity_probe_pulse(pulse_time) #drive 3P0
