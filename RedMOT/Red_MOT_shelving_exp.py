...
class Red_MOT_shelving(EnvExperiment):
    ...
    def build(self): 
        ...
        self.setattr_argument("Push_pulse_wait",NumberValue(4.0*1e-3,min=0.0*1e-3,max=10.00*1e-3,scale = 1e-3,
                      unit="ms"),"Detection")
    ...
    def run(self):
        ...
        for ii in range(len(self.x)):
            ...
            delay(self.Push_pulse_wait)  # Delay
