...
class Bragg_ARP_VRS_Double_exp(Scan1D, TimeFreqScan, EnvExperiment):
    ...
    def build(self, **kwargs):
        ...
        self.setattr_argument("mom_transfer",BooleanValue(True),"parameters")
    ...
    def measure(self, time, frequency):
        ...
        self.Bragg.set_AOM_attens([("Dipole",22.0 ), ("Homodyne",30.0)])
        ...
        # Momentum transfer stage ###################################
        delay(10*us)
        if self.mom_transfer:
            with parallel:
                self.scan_dds.cpld.io_update.pulse_mu(8)
        ...
        # # Scan the cavity probe for bare cavity resonance
        ...
        # self.MOTs.dac_0.load()
        # delay(1*ms)
        # self.MOTs.AOMs_off(['Probe'])# turn probe beam on
        # self.MOTs.dac_0.write_dac(3, 0.0) #trigger scan
        # self.MOTs.dac_0.load()
        # delay(10*us)
        # delay(pulse_time)
        # delay(10*us)
