...
class Bragg_ARP_Sequential_exp(Scan1D, TimeFreqScan, EnvExperiment):
    ...
    def build(self, **kwargs):
        ...
        self.setattr_argument(f"num_pulses", NumberValue(1, min=0, max=5, scale=1),  "parameters")
    ...
    def measure(self, time, frequency):
        ...
        self.prepare_freq_ramp(pulse_time, self.Bragg.freq_Bragg1) #fix center of Bragg 1 at 100MHz
        delay(1 * ms)
