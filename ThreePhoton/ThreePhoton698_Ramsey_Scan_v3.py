...
class ThreePhoton698_Ramsey_Scan_v3(Scan1D, TimeFreqScan, EnvExperiment):
    ...
    def build(self, **kwargs):
        ...
        self.setattr_argument("Rabi_t_pi",
                              NumberValue(1*1e-3,min=0.0,max=20.00*1e-3,scale = 1e-3,
                               unit="ms"),"Params")
    ...
    def measure(self, time, frequency):
        ...
        delay(pulse_time)  # offset by half a micro second
