# -*- coding: utf-8 -*-
"""
Created on Mon Sep 19 19:03:23 2022
...
class PhaseSyncTest_v2(EnvExperiment):
    def build(self):
    ...
    def run(self):
        ...
        self.d1.set(81*MHz, phase=.5, ref_time=t)
        self.d2.set(82*MHz, phase=.25, ref_time=t)
