# -*- coding: utf-8 -*-
"""
Created on Tue Sep 20 12:43:02 2022
...
class Rabi_flopping_vphase(EnvExperiment):
    ...
    def build(self): 
        ...
        self.setattr_argument("Rabi_pulse_phase",
            Scannable(default=[RangeScan(0.0, 1.0, 20, randomize=False),NoScan(0.0)],scale=1,
                      unit="Turns"),"Floppin")
    ...
    def run(self):
        ...
        self.ttl7.off() # turn off quantization field trigger
        ...
        for ii in range(len(self.x)):
            ...
            self.ttl7.off() #reset B field pulse trigge
