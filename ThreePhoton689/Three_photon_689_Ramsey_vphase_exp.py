...
class Three_photon_Ramsey_vphase(EnvExperiment):
    ...
    def run(self):
        ...
        for ii in range(len(self.x)):
            ...
            if self.fscan:
                ...
                self.th_ph.set_switch2_phase_profile(0.0,t,0)
                self.th_ph.set_switch3_phase_profile(0.0,t,0)
                self.th_ph.set_switch1_phase_freq_profile(freqshift,phshift,t,1)
                self.th_ph.set_switch2_phase_profile(0.0,t,1)
                self.th_ph.set_switch3_phase_profile(0.0,t,1)
           ...
           # BACKGROUND IMAGE SEQUENCE
            ...
            #with parallel:
            delay(tdelay)
                #self.th_ph.set_switch1_phase_freq(freqshift,phshift,t)
