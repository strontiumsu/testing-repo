...
class CavityProbeTest(EnvExperiment):
    def build(self):
        ...
        self.setattr_argument("Probe_AOM_frequency",
            Scannable(default=[NoScan(85*1e6), RangeScan(70*1e6, 100*1e6, 10, randomize=False)],scale=1e6,
                      unit="MHz"),"Probe")
        ...
        self.urukul_hmc_ref_probe = self.get_device("urukul2_ch3")
